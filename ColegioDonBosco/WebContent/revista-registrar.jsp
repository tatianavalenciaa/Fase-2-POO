...
<body>
	...
	<div class="container">
		...
		<div class="d-flex flex-row mt-5">
			...
			<h3 class="mx-3">REGISTRAR REVISTA</h3>
		</div>
		...
		<div class="row mt-5">
			<div class="col-4">
				<form action="RevistaController?accion=registrar" method="post">
					<div class="mb-3">
					...
					<div class="mb-3">
						...
						<input type="text" class="form-control" id="periocidad" name="periocidad">
					</div>
					<div class="mb-3">
						<label for="fechaPub" class="form-label">Fecha Pub:</label>
						<input type="text" class="form-control" id="fechaPub" name="fechaPub"
